...
void tebFeedbackCallback(const teb_local_planner::FeedbackMsg::ConstPtr& msg) {
    // 检查反馈消息中的轨迹数量
    if (msg->trajectories.empty()) 
    {
        is_planning_failed = true;
    } 
    else 
    {
        is_planning_failed = false;
    }
}
