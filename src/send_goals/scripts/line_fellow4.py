...
max_vx = 0.2    # 表征最高限度 0.2 ，控制线速度  0.3  0.2
kp_x = 0.1    # 表征弯道降速 0.001，
kp_y = 100        # 表征横向纠偏 3
kp_w = -800     # -800 表征弯道转速 120  1000  -780
...
class LaneLines:
    ...
    def fit_poly(self, img, lane=2):
        ...
        # 确定边线
        left_x, left_y = self.find_lane_pixels(img, lane=0)
        right_x, right_y = self.find_lane_pixels(img, lane=1)
