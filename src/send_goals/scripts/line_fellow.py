...
def image_callback(img_mem_v, msg):
    bridge = CvBridge()
...
def camera(flag_task_v, img_mem_v, flag_lane_v, cmd_chassis_v, camera_config_v):
    rospy.init_node('camera_node', anonymous=True)
    rospy.Subscriber("/usb_cam/image_raw", Image, partial(image_callback, img_mem_v))
    rospy.spin()
